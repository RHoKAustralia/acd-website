            ...
            <div class="6u 12u$(mobile)">
                <div class="row uniform">
                    ...
                    <div class="7u 12u$(mobile)">
                        <input type="text" name="search" id="search" placeholder="&#xf002 Search" style="min-height:40px;min-width:98%;valign:middle;line-height:2em; font-family: Didact Gothid, FontAwesome;">
                    </div>
