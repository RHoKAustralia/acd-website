            ...
            <div class="row">
                <div class="3u 12u(mobile)">
                    <div class="box">
                        ...
                        <h2 style="text-align:center;"><span id="families_counter" class="counter" style="margin: 0; margin: auto !important;color:#9D2CAF;">0</span></h2>
        ...
        <div id="featured" class="container">
            ...
            <div class="testimonial">
                <div class="mask">
                    <ul>
                        <li class="anim1">
                            <div class="quote"><i class="icon fa-quote-left"></i>&nbsp; Hello, this is a quote from person 1.&nbsp; <i class="icon fa-quote-right"></i></div>
